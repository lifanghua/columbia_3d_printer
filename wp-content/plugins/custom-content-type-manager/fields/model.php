 ...
 * CCTM_model
 *
 * Implements an field that stores a reference to a model item (i.e. any attachment post)
 *
 * @package CCTM_FormElement
 */


class CCTM_model extends CCTM_FormElement
{
	public $props = array(
		'label' => '',
		'button_label' => '',
	...
	public function get_name() {
		return __('Model', CCTM_TXTDOMAIN);
	}
	...
	public function get_description() {
		return __('Model fields are used to store references to a model file that has been uploaded via the WordPress media uploader, e.g. stls.', CCTM_TXTDOMAIN);
	}
	...
	public function get_url() {
		return 'http://www.columbia.edu/~fl2335/';
	}
	...
	public function get_edit_field_instance($current_value) {
		...
		if (empty($this->button_label)) {
			$this->button_label = __('Choose Model', CCTM_TXTDOMAIN);
		}
